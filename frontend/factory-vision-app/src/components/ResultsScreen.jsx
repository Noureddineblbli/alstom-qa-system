  ...
  return (
    ...
    >
      ...
      <div className={`p-6 rounded-2xl border flex items-center gap-6 ${
        inspectionResult.status === 'match' 
          ? 'bg-green-500/10 border-green-500/50' 
          : 'bg-red-500/10 border-red-500/50'
      }`}>
        <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
          inspectionResult.status === 'match' ? 'bg-green-500' : 'bg-red-500'
        }`}>
          {inspectionResult.status === 'match' ? (
        ...
        <div>
          <h2 className="text-3xl font-bold uppercase tracking-tight">
            {inspectionResult.status === 'match' ? 'Valid Panel' : 'Unvalid Panel'}
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <div className="aspect-video rounded-xl overflow-hidden border border-white/10 relative group h-full w-full ">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#16191E] border border-white/5 rounded-xl overflow-hidden w-full h-full">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/5 bg-white/[0.02]">
                  ...
                  <th className="text-center p-3 font-mono text-[10px] uppercase text-white/40">Actual Calibre</th>
